...
def clip_metrics(
    ...
    _, image_sim = get_imageonly_clip_score(clip_model, images, original_images_feats, device)
...
def clip_metrics_style(
    ...
    _, prompt_A_style_sim, _ = get_clip_score(
        clip_model,
        image_feats,
        prompts_A_style,
        device,
    )
    _, prompt_B_style_sim, _ = get_clip_score(
        clip_model,
        image_feats,
        prompts_B_style,
        device,
    )
    _, prompt_A_content_sim, _ = get_clip_score(
        clip_model,
        image_feats,
        prompts_A_content,
        device,
    )
    _, prompt_B_content_sim, _ = get_clip_score(
        clip_model,
        image_feats,
        prompts_B_content,
        device,
    ...
    return (
        ...
        prompt_A_style_sim,
        prompt_B_style_sim,
        prompt_A_content_sim,
        prompt_B_content_sim,
    )
