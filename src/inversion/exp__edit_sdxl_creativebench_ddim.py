...
SAVE_DIR = (
    f"results_sdxl/inversion/glyph_creativebench/ddim_edit/"
    f"{START_TIME}_"
    f"seed_{SEED}_"
...
prompts_A, prompts_B = prepare_prompts_glyph_creative_bench(n_samples_per_prompt=N_SAMPLES_PER_PROMPT)
noises = torch.randn(
