...
SAVE_DIR = (
    f"results_sd3/glyph_creative/edit/different_templates_{USE_DIFFERENT_TEMPLATES}/"
    f"{START_TIME}_"
    f"seed_{SEED}_"
...
if distributed_state.is_main_process:
    ...
    original_images_A_feats = extract_all_images(
        all_original_images_A, clip_model, distributed_state.device, batch_size=BATCH_SIZE
    )
    ...
    patched_images_df["Block_patched"] = [f"A{set_to_string(ATTENTIONS_TO_PATCH)}" for _ in range(len(prompts_A))]
